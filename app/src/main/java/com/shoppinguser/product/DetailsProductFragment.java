...
public class DetailsProductFragment extends Fragment
{
    ...
    ImageView imageProduct, imageLoveWhiteProduct, imageLoveRedProduct;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState)
    {
        ...
        imageLoveWhiteProduct = root.findViewById(R.id.img_love_white_product);
        imageLoveRedProduct = root.findViewById(R.id.img_love_red_product);
        ...
        buttonAddToCart.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                ...
                ProductModel model = new ProductModel(Category_ID, imgProduct, nameProduct, priceProduct, statusProduct, String.valueOf(buttonNumberQuantity.getNumber()), descriptionProduct);
                dataReference.child("cart").child(ID).setValue(model);
        ...
        imageLoveWhiteProduct.setOnClickListener(new View.OnClickListener()
        {
            @Override
            public void onClick(View v)
            {
                imageLoveRedProduct.setVisibility(View.VISIBLE);
                imageLoveWhiteProduct.setVisibility(View.GONE);
                Toast.makeText(root.getContext(), "Added to your follow", Toast.LENGTH_SHORT).show();
            }
        });
    }
