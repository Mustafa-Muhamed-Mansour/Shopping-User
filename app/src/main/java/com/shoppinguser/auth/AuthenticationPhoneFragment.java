...
import com.shoppinguser.model.UserModel;
...
public class AuthenticationPhoneFragment extends Fragment
{
    ...
    NestedScrollView parentNestedScrollViewView;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState)
    {
        ...
        parentNestedScrollViewView = root.findViewById(R.id.parent_scroll_layout);
        ...
        callbacks = new PhoneAuthProvider.OnVerificationStateChangedCallbacks()
        {
            ...
            public void onVerificationFailed(@NonNull FirebaseException e)
            {
                ...
                Snackbar.make(parentNestedScrollViewView, e.getMessage(), Snackbar.LENGTH_SHORT).show();
            }
